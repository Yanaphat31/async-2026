...
async def main():
    ...
    # รันหลาย operations พร้อมกันแบบ asynchronous และรวบรวมผลลัพธ์เป็น ordered list
    ...
    print(f"{ctime()} Execution Completed in: {time() - start:.2f} seconds") # แสดงเวลารวมที่ใช้ในการประมวลผลทั้งหมด
